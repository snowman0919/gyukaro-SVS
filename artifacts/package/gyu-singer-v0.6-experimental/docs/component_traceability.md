...
| Style/technique | TechSinger | preset and curve controls absent | `StyleEncoder` | quality controller condition | residual-flow F0 target; teacher style rows in compact stage | full-module gradient test | integrated, controls partly calibrated |
