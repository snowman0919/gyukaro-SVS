...
def main() -> None:
    ...
    report = {
        "status": "objective_pass_human_listening_pending",
        "backend": "gyu-singer-rc9",
        "required_checks": ["same melody and phrase timing", "rapid sections usable", "GYU identity retained", "no severe metallic or sustained artifact"],
        "files": rows,
