#!/usr/bin/env python3
"""Package the quality-proven frozen OmniVoice + SoulX phrase runtime."""
...
root = Path("artifacts/package/gyu-hybrid-singer-v0.4-quality-runtime")
...
for script in ("generate_omnivoice_phrase.py", "probe_soulx_score.py"):
