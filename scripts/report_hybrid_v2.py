...
Generated by `scripts/report_hybrid_v2.py`. CUDA run: {training['steps']} steps, AdamW LR `{training['learning_rate']}`, batch {training['batch_size']}. Train rows: {training['real_rows']} real GYU plus {training['pseudo_rows']} accepted low-trust pseudo-singing; validation/test: {training['validation_rows']}/5. Teacher representation rows: {training['teacher_rows']}, coefficient {training['teacher_loss_weight']}.
